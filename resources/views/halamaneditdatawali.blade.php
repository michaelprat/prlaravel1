	...
	{{-- start: Header --}}
		...
		<div class="row-fluid">
            ...
            <div class="box span12">
                    ...
                    {!! Form::model($data,['route'=>['wali.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
                          <div class="control-group">
								<table width="600px">
							<tr>
								<td>{!! Form::label('id_wali','Masukan Id wali',array('class'=>"control-label",'for'=>"typeahead"))!!}</td>
							 <td>
								<div class="controls">
                           ...
                           <tr>
						   <div class="control-group">
						<td>	{!! Form::label('nama_wali','Masukan Nama wali:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::text('nama_wali',null,array('placeholder'=>"isi nama wali")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
