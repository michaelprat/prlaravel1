		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Data siswa baru</h2>
					
					</div>
					<div class="box-content">
                    {!! Form::model($data,['route'=>['tambahdatasiswa.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
							...
							<tr>
							 ...
							 <td>
								<div class="controls">
							        {!! Form::text('id',null,array('placeholder'=>"isi dengan angka")) !!}
							  </div>
                               </td>	
							</div>
                            </tr> 
                           <tr>
						   <div class="control-group">
						<td>	{!! Form::label('nama_siswa','Masukan Nama siswa:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::text('nama_siswa',null,array('placeholder'=>"isi nama siswa")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
							   <tr>
							<div class="control-group">
							<td>  <label class="control-label" for="date01">Date input</label></td>
							<td>  
							<div class="controls">
							{!! Form::date('tanggal_lahir', \Carbon\Carbon::now()); !!}	{{--<input type="text" class="input-xlarge datepicker" id="date01" value="02/16/12">--}}
							  </div>
                               </td>
							</div>
                            </tr>
