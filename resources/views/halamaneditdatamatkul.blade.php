	...
	{{-- start: Header --}}
		...
		<div class="row-fluid">
            ...
            <div class="box span12">
                    ...
                    {!! Form::model($data,['route'=>['matkul.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
                          <div class="control-group">
                           ...
                           <tr>
						   <div class="control-group">
						<td>	{!! Form::label('nama_matkul','Masukan Nama Matkul:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::text('nama_matkul',null,array('placeholder'=>"isi nama matkul")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
